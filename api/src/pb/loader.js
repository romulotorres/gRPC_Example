...
module.exports = function load({ serviceName, fileName, address, credentials = grpc.credentials.createInsecure() }) {
  const protoDef = protoLoader.loadSync(path.resolve(__dirname, `${fileName}.proto`), protoConfig)
